  ...
  return (
    <header  className="hide-contact  overflow-hidden">
      <div id="intro-example" >
        ...
        >
    <img  src={props.cover} width="100%" className="contact-header-image" />
        
      
          <div className="d-flex  justify-content-center  mx-0 justify-content-lg-end   align-items-end p-5 contact-header--title h-100">
            <h1 className={`mb-3 mx-4 text-center  col-xl-4 col-10 fw-bold  ${dark?"contact-header--title--text-dark" :"contact-header--title--text"}   px-3 py-5 `}>
